                              ...
                              {userData.jobs.map((job) => (
                                <tr key={job._id}>
                                  ...
                                  <td className="px-3 py-2 text-gray-900">
                                    {job.address ? `${job.address.street}, ${job.address.city}` : 'N/A'}
                                  </td>
                                  ...
                                  <td className="px-3 py-2 text-gray-900">{formatDistance(job.distanceTraveled)}</td>
                                  <td className="px-3 py-2 text-gray-900">
                                    {job.completedDate ? formatDate(job.completedDate) : 'N/A'}
                                  </td>
                                  <td className="px-3 py-2 text-gray-900 font-medium">
                                    {job.status === 'completed' 
                                      ? formatCurrency(job.distanceTraveled * wageSettings.ratePerKm + wageSettings.fuelAllowancePerJob)
                                      : 'N/A'
                                    }
                                  </td>
                                </tr>
